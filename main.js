...
const fragmentShader = `
  ...
  void main() {
    vec3 color = vec3(1.0, 0.8, 0.0); // Yellow color
    vec3 normal = normalize(vNormal);
    float intensity = dot(normal, vec3(0.0, 0.0, 2.0)); // Use the dot product with the (0, 0, 2) direction as intensity
...
const STexture = new THREE.TextureLoader().load('sunmap.jpg');
//const sunMaterial = new THREE.MeshBasicMaterial({ color: color , map:STexture, emissive: color, emissiveIntensity: 3 });
// Create the ShaderMaterial for the sun
const sunMaterial = new THREE.ShaderMaterial({
  vertexShader,
  fragmentShader,
  uniforms:{texture:{value : STexture}},
});
...
const revolutionTimeScale = 0.005;//Used for revolution
const planetRotationSpeeds = [0.02, 0.03, 0.009, 0.01, 0.009, 0.0075, 0.006, 0.0045]; // Rotation speeds for each planet
 ...
 const EMtexture = new THREE.TextureLoader().load('mercur.jpeg');
 ...
 const EEtexture = new THREE.TextureLoader().load('venus.jpg');
 ...
 const Etexture = new THREE.TextureLoader().load('emap.jpeg');
 const EGTexture = new THREE.TextureLoader().load('earthbump.jpg');
 ...
 const ECloudsTexture = new THREE.TextureLoader().load('Earth-clouds.png');
 ...
 const moongTexture = new THREE.TextureLoader().load('moong.png');
 ...
 const moonDistance = 4; // Distance from the center of the Earth
 ...
 //mars
   ...
   const Mtexture = new THREE.TextureLoader().load('mmap.jpeg');
   ...
   const Mgtexture = new THREE.TextureLoader().load('redg.png');
  ...
  //jupiter
   ...
   const JTexture = new THREE.TextureLoader().load('Jupmap.jpeg');
   ...
   const JCTexture = new THREE.TextureLoader().load('Jupcloud.png');
   ...
   const SaTexture = new THREE.TextureLoader().load('saturnmap.jpg');
   ...
   const Urtexture = new THREE.TextureLoader().load('uranmap.jpg');
   ...
   const Netexture  = new THREE.TextureLoader().load('neptune.jpg');
